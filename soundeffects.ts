...
class SoundBuffer {
    ...
    //% blockCombine
    get wave() { return this._buf.getNumber(NumberFormat.UInt16LE, 0); }
    //% blockSetVariable="soundeffect"
    //% blockCombine
...
namespace soundEffects {
     ...
     * @param wave wave form for the effect; eg: WaveType.Noise
     ...
     */
    //% blockId="create_sound" block="sound wave %wave for %duration ms, freq %f0 to %f1||, vol %v0 to %v1"
    //% inlineInputMode=inline
    //% expandableArgumentMode="toggle"
    //% blockSetVariable=soundeffect
    //% weight=90
    export function createSound(wave: WaveType, duration: number, f0: number, f1: number, v0: number=255, v1: number=0): SoundBuffer {
